...
const App: React.FC = () => {
  ...
  }, [primaryImageUrl, secondaryImageUrl, selectedTransformation, maskDataUrl, customPrompt, multiImageUrls, t, imageAspectRatio, applyWatermarks]);
          ...
          <div className="container mx-auto p-2 sm:p-4 md:p-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col p-6 bg-[var(--bg-card-alpha)] backdrop-blur-lg rounded-xl border border-[var(--border-primary)] shadow-2xl shadow-black/20">
                <h2 className="text-lg md:text-xl font-semibold mb-4 text-[var(--accent-primary)] self-start">{t('app.result')}</h2>
